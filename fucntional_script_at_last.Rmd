...
#I pray
inputdata <- read.csv(file = "./GDSC1_public_raw_data_25Feb20.csv", nrows = 5000)
...
if (RMSE >=.3){next}else{print("RMSE is OK")} 
if (IC50 >= 100){next}else{if (IC50 <= 0){next}else{print("IC50 is OK")}}
#Graph Function
